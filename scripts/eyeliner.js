var eyelinarobj=JSON.parse(localStorage.getItem("masacraEyelinar"));
var productArr=[] ;
showdata(eyelinarobj);

function filterCat(){
  var selected = document.querySelector("#brandFilter").value;

  var filterdList =eyelinarobj.filter(function(elem){
...
var selected = document.querySelector("#priceSort").value;
 ...
 if (selected == "low"){
  ...
  console.log(eyelinarobj);
  showdata(eyelinarobj);

}


function showdata(eyelinarobj){
    document.getElementById("containershra").innerHTML="";

    eyelinarobj.map(function(el){
