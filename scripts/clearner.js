var faceWash=JSON.parse(localStorage.getItem("faceArr"));
    var productArr=[] ;
    showdata(faceWash);
    ...
    function filterCat(){
      ...
      var filterdList =faceWash.filter(function(elem){
    ...
    function showdata(faceWash){
        document.getElementById("containershra").innerHTML="";

        faceWash.map(function(el){
