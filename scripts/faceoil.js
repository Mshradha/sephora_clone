var faceOils=JSON.parse(localStorage.getItem("nutArr"));
var productArr=[] ;
showdata(faceOils);
...
function filterCat(){
  ...
  var filterdList =faceOils.filter(function(elem){
...
var selected = document.querySelector("#priceSort").value;
 ...
 if (selected == "low"){
  ...
  console.log(faceOils);
  showdata(faceOils);

}

function showdata(faceOils){
    document.getElementById("containershra").innerHTML="";

    faceOils.map(function(el){
